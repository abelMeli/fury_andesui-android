...
internal interface AndesBadgeTypeInterface {
    ...
    fun icon(context: Context, size: Int, backgroundColor: Int): Drawable? = null
}
...
internal class AndesHighlightBadgeType : AndesBadgeTypeInterface {
    ...
    override fun icon(context: Context, size: Int, backgroundColor: Int): Drawable = buildColoredCircularShapeWithIconDrawable(

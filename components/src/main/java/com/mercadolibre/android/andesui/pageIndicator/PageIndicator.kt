...
open class PageIndicator @JvmOverloads constructor(
    ...
    init {
        ...
        dotSizeMap = mapOf(
            BYTE_6 to ta.getDimensionPixelSize(R.styleable.PageIndicator_piSize1, 8.dp),
            BYTE_5 to ta.getDimensionPixelSize(R.styleable.PageIndicator_piSize2, 7f.dp),
            BYTE_4 to ta.getDimensionPixelSize(R.styleable.PageIndicator_piSize3, 6.5f.dp),
            BYTE_3 to ta.getDimensionPixelSize(R.styleable.PageIndicator_piSize4, 5f.dp),
            BYTE_2 to ta.getDimensionPixelSize(R.styleable.PageIndicator_piSize5, 4.5f.dp),
            BYTE_1 to ta.getDimensionPixelSize(R.styleable.PageIndicator_piSize6, 2.5f.dp)
        )
        ...
        defaultPaint.color = ta.getColor(
            ...
            ContextCompat.getColor(getContext(), R.color.andes_gray_550_solid)
        )
        selectedPaint.color = ta.getColor(
            R.styleable.PageIndicator_piSelectedColor,
            ContextCompat.getColor(getContext(), R.color.andes_blue_ml_500)
        )

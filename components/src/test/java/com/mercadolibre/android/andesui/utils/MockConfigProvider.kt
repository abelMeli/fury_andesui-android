...
internal object MockConfigProvider {
    ...
    private fun mockCurrencies(): HashMap<AndesMoneyAmountCurrency, AndesCurrencyInfo> {
        ...
        R.string.andes_currency_peso_plural, R.string.andes_currency_centavo_singular, R.string.andes_currency_centavo_plural)
        currencies[AndesMoneyAmountCurrency.BRL] = AndesCurrencyInfo("R$", 2, R.string.andes_currency_real_singular,
        R.string.andes_currency_real_plural, R.string.andes_currency_centavo_singular, R.string.andes_currency_centavo_plural)
        ...
        R.string.andes_currency_colon_plural, R.string.andes_currency_centimo_singular, R.string.andes_currency_centimo_plural)
        ...
        R.string.andes_currency_euro_plural, R.string.andes_currency_cent_singular, R.string.andes_currency_cent_plural)
        ...
        R.string.andes_currency_balboa_plural, R.string.andes_currency_centesimo_singular, R.string.andes_currency_centesimo_plural)
        currencies[AndesMoneyAmountCurrency.PEN] = AndesCurrencyInfo("S", 2, R.string.andes_currency_sol_singular,
        R.string.andes_currency_sol_plural, R.string.andes_currency_centimo_singular, R.string.andes_currency_centimo_plural)
        currencies[AndesMoneyAmountCurrency.USD] = AndesCurrencyInfo("USD", 2, R.string.andes_currency_dollar_singular,
        R.string.andes_currency_dollar_plural, R.string.andes_currency_centavo_singular, R.string.andes_currency_centavo_plural)
        ...
        R.string.andes_currency_bolivar_plural, R.string.andes_currency_centavo_singular, R.string.andes_currency_centavo_plural)
        ...
        R.string.andes_currency_fomento_plural, R.string.andes_currency_centavo_singular, R.string.andes_currency_centavo_plural)
        currencies[AndesMoneyAmountCurrency.BOB] = AndesCurrencyInfo("Bs", 2, R.string.andes_currency_boliviano_singular,
        R.string.andes_currency_boliviano_plural, R.string.andes_currency_centavo_singular, R.string.andes_currency_centavo_plural)
        currencies[AndesMoneyAmountCurrency.PYG] = AndesCurrencyInfo("₲", 0, R.string.andes_currency_guarani_singular,
        R.string.andes_currency_guarani_plural, R.string.andes_currency_centimo_singular, R.string.andes_currency_centimo_plural)
        currencies[AndesMoneyAmountCurrency.GTQ] = AndesCurrencyInfo("Q", 2, R.string.andes_currency_quetzal_singular,
        R.string.andes_currency_quetzal_plural, R.string.andes_currency_centavo_singular, R.string.andes_currency_centavo_plural)
        currencies[AndesMoneyAmountCurrency.HNL] = AndesCurrencyInfo("L", 0, R.string.andes_currency_lempira_singular,
        R.string.andes_currency_lempira_plural, R.string.andes_currency_centavo_singular, R.string.andes_currency_centavo_plural)
        currencies[AndesMoneyAmountCurrency.NIO] = AndesCurrencyInfo("C", 0, R.string.andes_currency_cordoba_singular,
        R.string.andes_currency_cordoba_plural, R.string.andes_currency_centavo_singular, R.string.andes_currency_centavo_plural)
        currencies[AndesMoneyAmountCurrency.CUC] = AndesCurrencyInfo("$", 2, R.string.andes_currency_cubano_singular,
        R.string.andes_currency_cubano_plural, R.string.andes_currency_centavo_singular, R.string.andes_currency_centavo_plural)
        return currencies
    }
